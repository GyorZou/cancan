...
-(void)restartDidWrite:(CBPeripheral *)peripheral c:(CBCharacteristic *)characteristic error:(NSError *)error
{
    [babyCentralManager restartDidWrite:peripheral c:characteristic error:error];
}
