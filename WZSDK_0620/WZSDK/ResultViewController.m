        ...
        case 15:{
            ...
            for (NSString * path in paths) {
                ...
                UIAlertAction *action = [UIAlertAction actionWithTitle:cmp style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
                    NSString * url =  [[NSBundle mainBundle] pathForResource:cmp ofType:nil];
                    [face bleDevice:_curDevice sendCommandCode:(WZBluetoohCommand)indexPath.row extraData:url];
                }];
            ...
            UIAlertAction * input = [UIAlertAction actionWithTitle:@"固件url" style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) {
                
                UIAlertController * alert = [UIAlertController alertControllerWithTitle:@"固件.zip的url" message:nil preferredStyle:UIAlertControllerStyleAlert];
                ...
                UIAlertAction * action0 = [UIAlertAction actionWithTitle:@"ok" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
                    ...
                    if (![field.text hasPrefix:@"http"]) {
                        [SVProgressHUD showInfoWithStatus:@"输入url有误"];
                        return ;
                    }
            ...
            [alertController addAction:input];
